...
#         excell.columns = [self.alterColum(i) for i in excell.columns]
...
#             city = row['area_title']
#             stateCode, areaName = self.getStateCodeFromCity(city)
#             areaInstanceArr = []
#             if stateCode:
...
#                 custom_state_code = self.getCustomStateCode(city)
...
#                 stateCityMappingInstance = bls_state_city_mapping.objects.filter(
#                     state=stateInstance, city=areaName)
#                 if not stateCityMappingInstance:
#                     stateCityMappingInstance = bls_state_city_mapping(
#                         state=stateInstance,
#                         city=areaName
