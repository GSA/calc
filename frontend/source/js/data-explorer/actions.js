...
export const TOGGLE_CAT_LEVEL = 'TOGGLE_CAT_LEVEL';
...
export function toggleCatLevel(level) {
  console.log("TOOOOOOOGGGGGLIIIINNGGGGG"+level);
  return { type: TOGGLE_CAT_LEVEL, level };
}
